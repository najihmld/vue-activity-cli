      ...
      <section class="container">
        <div class="columns">
          <div class="column is-3">
            <a v-if="!isFormDisplayed" @click="toggleFormDisplayed" class="button is-primary is-block is-alt is-large" href="#">New Activity</a>
            <div v-if="isFormDisplayed" class="create-form">
              ...
              <form>
                ...
                <div class="field is-grouped">
                  ...
                  <div class="control">
                    <button @click="toggleFormDisplayed" class="button is-link">Cancel</button>
                  </div>
                </div>
              </form>
            </div>
